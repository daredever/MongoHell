...
Предлагаю рассмотреть решение на примере. Для простоты будем считать, что сейчас нам достаточно записать данные в монго дб, а потом когда-нибудь 
мы их прогрузим в конечную систему.
