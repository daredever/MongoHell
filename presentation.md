...
Меня зовут Щербаков Щербаков, и я занимаюсь разработкой бэк-энда также в ЦРТ и мы хотели бы рассказать вам о внедрении MongoDB в .net проект.
...
#### слайд --> (картинка)
Что мы имеем внутри mongodb? У нас может быть n баз данных, в каждой из которых по n коллекций в каждой из которых может хранится n абсолютно любых документов.
...
#### слайд --> (standalone yml)
и наш yaml выглядел так -- слайд standalone

однако согласно документации мининимальная конфигация монги - реплика сет
